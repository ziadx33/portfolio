...
export default function LoadingPage({ loadings }: LoadingPageInterface) {
    ...
    useGSAP(async () => {
        ...
        if (overallProgress === 100) {
            ...
            gsap.to(".loading-container", {
                borderBottomLeftRadius: (windowDimensions.width / 2),
                borderBottomRightRadius: (windowDimensions.width / 2),
    ...
    return (
        <div className="loading-container border-2 w-full h-full fixed bg-white z-50 dark:bg-slate-950 flex flex-col items-center justify-center px-8 md:px-12 lg:px-24 3xl:px-[30rem]">
            <h1 className="md:text-6xl text-3xl font-bold w-fit mx-auto md:mb-12 mb-6 transition md:text-start text-center">welcome to TheGreatagen <Vim width={windowDimensions.width > 768 ? 90 : 50} height={90} /></h1>
