			...
			<div className="flex gap-2 lg:flex-row flex-col">
				<DropdownMenu>
					...
					<DropdownMenuContent>
						...
						<DropdownMenuLabel className="lg:block hidden">
							View as
						</DropdownMenuLabel>
				...
				<div
					className="my-auto flex flex-wrap gap-1.5 w-full overflow-x-scroll"
					ref={techsRef}
				>
					<Button
						variant="outline"
						className="w-12 h-9 p-0 my-auto"
						onClick={() =>
							setTechnologiesList(
					...
					{technologiesList?.map((technology) => {
						return (
							<Button
								...
								className={`h-9 w-fit border-2 dark:hover:bg-transparent   rounded-xl ${
									technology.checked
										? "border-slate-950 dark:border-gray-400"
										: ""
								}`}
								variant="outline"
								key={technology.name}
